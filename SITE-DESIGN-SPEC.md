...
> 3. **De disabled-staat van "Vastleggen" (presentatie) meldt vooraf waarom.** Zodra `consent_withdrawn_at` staat, geeft de backend op de presentatieroute gegarandeerd een 409 met een Engelse zin (admin.py:1171-1176). De knop staat dan `disabled` met een Nederlandse `title`, in plaats van de aanroep te laten mislukken.
