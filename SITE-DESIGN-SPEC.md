...
`#retention` (Bewaartermijnen, §7.3.1) en `#placements` (Plaatsingen, §7.3.3) zijn gebouwd; `#retention` staat in de sidebargroep System, boven Settings. Nog te bouwen: `#gdpr` (§7.3.5).
