...
>
> Bewaakt door `scripts/admin_sections_check.py` (de hele sectie tegen gestubde routes) en `scripts/admin_pagination_check.py` (120 rijen naast de paginagrootte van 100).
