...
**Meetup en referral: de hele tweede zin wordt vervangen, niet alleen de bracket.** Voor deze twee kanalen vervalt de zin "Wij vonden uw [bron-omschrijving] op [datum] in het kader van..." volledig en wordt zij vervangen door onderstaande vaste zin; de rest van het blok (bewaartermijn, rechten, STOP, klachtrecht) blijft ongewijzigd staan. Voor meetup blijft ook de grondslagzin staan. **Voor referral wordt daarnaast de grondslagzin vervangen**, omdat de werkelijke grondslag `toestemming_referral` is (§1.3) en art. 14 lid 1 sub c de echte grondslag vereist: "Grondslag: gerechtvaardigd belang bij werving." wordt "Grondslag: toestemming, gegeven vóór dit eerste contact." (EN: "Legal basis: consent, given before this first contact."). De referral-bevestigingsmail die het systeem verstuurt (`services/email_templates.py`, `referral_confirm`) gebruikt precies deze twee vervangingen.
