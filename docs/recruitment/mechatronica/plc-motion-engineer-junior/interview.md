...
Briefing: Deze juniorrol combineert PLC-programmeren met motion control bij machinebouwers in de Brainport-regio, met expliciete inbedrijfstelling op locatie onder begeleiding. De briefing richt zich op basisbegrip van PLC-logica en motion control, en op realistische verwachtingen over het werk op locatie.
